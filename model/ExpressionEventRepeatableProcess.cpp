...
#include "/Users/localadmin/ecell3/ecell/dm/ExpressionProcessBase.hpp"
...
public:
    ...
    LIBECS_DM_OBJECT( ExpressionEventRepeatableProcess, Process )
    {
        ...
        PROPERTYSLOT_SET_GET( Real, RepeatFlag );
    ...
    SET_METHOD( libecs::Real, RepeatFlag )
    {
        theRepeatFlag = value;
    }

    GET_METHOD( libecs::Real, RepeatFlag )
    {
