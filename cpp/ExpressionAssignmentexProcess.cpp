...
LIBECS_DM_CLASS_MIXIN( ExpressionAssignmentexProcess, Process,
                       SingleExpressionProcessBase )
{
public:
    LIBECS_DM_OBJECT( ExpressionAssignmentexProcess, Process )
    {
    ...
    virtual ~ExpressionAssignmentexProcess()
    {
        // ; do nothing
    }
...
LIBECS_DM_INIT( ExpressionAssignmentexProcess, Process );
