...
LIBECS_DM_CLASS( ODE45eventStepper, AdaptiveDifferentialStepper )
{

public:

    LIBECS_DM_OBJECT( ODE45eventStepper, Stepper )
    {
...
LIBECS_DM_INIT( ODE45eventStepper, Stepper );


ODE45eventStepper::ODE45eventStepper()
    :
...
void ODE45eventStepper::initialize()
{
...
bool ODE45eventStepper::calculate( Real aStepInterval )
{
...
Real ODE45eventStepper::judgeEvent( Real aStepInterval, Real aCurrentTime )
{
...
void ODE45eventStepper::updateInternalState( Real aStepInterval )
{
    ...
    if( aStepInterval < theMinStepInterval ){
        aStepInterval = theMinStepInterval;
    }
