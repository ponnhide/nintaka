...
LIBECS_DM_CLASS_MIXIN( ExpressionAlgebraicexProcess, Process,
                       SingleExpressionProcessBase )
{
public:
    
    LIBECS_DM_OBJECT( ExpressionAlgebraicexProcess, Process )
    {
    ...
    virtual ~ExpressionAlgebraicexProcess()
    {
        ; // do nothing
    }
    
	
    SET_METHOD( String, mathml )
    {
        theMathml = value;
    }

    GET_METHOD( String, mathml )
    {
        return theMathml;
    }
...
LIBECS_DM_INIT( ExpressionAlgebraicexProcess, Process );
